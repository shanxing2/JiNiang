...
#If DEBUG Then
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles btnParseCmd.Click
        ...
        'Try
        '	Dim root = MSJsSerializer.Deserialize(Of RoomViewerInfoEntity.Root)(value)
...
#End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Dim value = txtCmdSource.Text
        m_MainForm.DanmuControl.SendDanmuByEventsForTest(New DanmuInfo With {.Context = value, .Source = DanmuSource.Internal, .Count = 2})
    End Sub
